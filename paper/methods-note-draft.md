...
**Limitations.** P03's strict regex is a lower bound; the broad regex (ACPR-inclusive) is the upper bound. The post-2009 decline is partially confounded by portfolio shift toward chemoprevention and mass drug administration (MDA). P01 measures CT.gov results-posting, distinct from peer-reviewed publication. Trials registered only in PACTR/CTRI/ISRCTN are outside this corpus.
